...
CREATE TABLE IF NOT EXISTS `mydb`.`publicacao` (
  ...
  INDEX `fk_publicacao_usuario_idx` (`usuario_cpf` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`interesse` (
  ...
  INDEX `fk_interesse_usuario1_idx` (`usuario_cpf` ASC) VISIBLE,
  INDEX `fk_interesse_publicacao1_idx` (`publicacao_idpublicacao` ASC) VISIBLE,
